...
//                loginbutton.setVisibility(View.GONE);
        ...
        getpassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final BiometricPrompt.PromptInfo promptInfo = new BiometricPrompt.PromptInfo.Builder().setTitle("Verify fingerprint to continue")
                        .setDescription("Use your fingerprint to get passwords ").setDeviceCredentialAllowed(true).build();
...
//        String fontPath = "@fonts/sfprodisplaymedium.ttf"; // Replace with your font path
